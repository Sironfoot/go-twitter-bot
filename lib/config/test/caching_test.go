...
func TestCaching(t *testing.T) {
	...
	err = config.LoadWithCaching("_complexCachingTest.json", "test", &configDataCopy)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = config.LoadWithCaching("_complexCachingTest.json", "test", &preCacheConfigData)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = config.LoadWithCaching("_complexCachingTest.json", "test", &postCacheConfigData)
	if err != nil {
		t.Fatal(err)
	}
...
func TestCachedVersionsAreCopies(t *testing.T) {
	...
	err := config.LoadWithCaching("complex.json", "test", &complex1)
	if err != nil {
		t.Fatal(err)
	}

	var complex2 complex
	err = config.LoadWithCaching("complex.json", "test", &complex2)
	if err != nil {
		t.Fatal(err)
	}
